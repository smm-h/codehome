...
supervisor.* internals are deprecated and will be enforced by lint
in Phase 4.
...
# -- Bus (event system) --
from supervisor.bus import Event, fire, fire_sync, on

# -- CLI construction & helpers --
from supervisor.cli import build_parser
from supervisor.cli_helpers import add_branch_flag, add_deploy_flags, dispatch_subcommand, resolve_optional
from supervisor.config import RepoConfig, get_repo, load_server_config
from supervisor.config import (  # Original name is load_repos; renamed to list_repos for SDK
    load_repos as list_repos,
)
from supervisor.dispatch import dispatched, server_running, server_url
...
from supervisor.resolution import (
    BranchContext,
    active_context,
    parse_qualified,
    resolve,
...
from supervisor.serve.dependencies import get_gh_token
...
# -- State (storage APIs) --
from supervisor.state import ConfigStore, FileStore, Scope, StateStore, lock, services
