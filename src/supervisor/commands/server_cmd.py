...
from supervisor.config import load_server_config, server_config_exists
from supervisor.http_client import _resolve_token_file
from supervisor.paths import ROOT, SUPERVISOR_DIR, resolve_global
from supervisor.serve import DEFAULT_PORT, PORT_FILE, read_server_info, read_server_info_raw, read_server_url
from supervisor.utils import die, green, red, yellow
...
def _maybe_rebuild() -> None:
    ...
    build_output = ROOT / "src" / "supervisor" / "serve" / "static" / "index.html"
