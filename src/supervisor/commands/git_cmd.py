...
from supervisor.migrations import MIGRATION_RE, detect_stale_migrations, remigrate_file
from supervisor.paths import MIGRATIONS_DIR, REBASE_STATE, base_ref, branch_dir, repo_anchor
from supervisor.resolution import resolve
from supervisor.summary import (
...
from supervisor.utils import claude_prompt, colorize, die, warn
...
def cmd_compare(args: argparse.Namespace) -> None:
    ...
    from supervisor.aliases import require_worktree, resolve_alias
    ...
    print(flush=True)
    if use_delta:
        from supervisor.git import pipe_through_delta
...
def cmd_push(args: argparse.Namespace) -> int | None:
    ...
    from supervisor.git import gh_repo as _gh_repo
    from supervisor.session import get_process_id
    from supervisor.utils import atomic_json_write, load_json, open_url
    ...
    from supervisor.deploy_shared import native_change_gate
