...
from supervisor.git import commits_behind, git, iter_all_branches
from supervisor.linear_shared import load_cache, load_issue_link
from supervisor.paths import PROTECTED_BRANCHES, worktree_path
...
def _print_server_status() -> None:
    ...
    from supervisor.utils import dim, render_box_table
