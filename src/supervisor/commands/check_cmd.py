...
import supervisor.checks.gate
import supervisor.checks.precommit  # noqa: F401
...
from supervisor.paths import ROOT, branch_dir as _branch_dir
...
#!/bin/sh
# {_HOOK_SENTINEL}
exec supervisor check precommit
"""

_PRE_PUSH_HOOK = f"""\
#!/bin/sh
# {_HOOK_SENTINEL}
exec supervisor check gate
"""
...
def _load_extensions_if_available() -> BranchContext | None:
    ...
    """
    from supervisor.cli_helpers import resolve_optional
