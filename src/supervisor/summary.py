...
from supervisor.git import exclude_args, git, pipe_through_delta
from supervisor.linear_shared import load_issue_link
...
def worktree_info(
    ...
    from supervisor.git import ignorable_patterns, staleness_tag
