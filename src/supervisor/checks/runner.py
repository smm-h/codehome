...
Relation to :mod:`supervisor.tests.framework.runner`: the test runner
...
from supervisor.checks.registry import CheckContext, CheckRegistry, _registry
from supervisor.checks.result import CheckResult, GroupReport

if TYPE_CHECKING:
    from supervisor.checks.registry import CheckEntry
