...
from supervisor.linear_shared import auto_advance_state, load_issue_link
from supervisor.paths import context_file, worktree_path
from supervisor.progress import append_session_header
