...
from supervisor.serve.branches import (
...
from supervisor.serve.explain_ops import (
    DIFF_LINE_LIMIT,
    generate_summary,
    get_cached_summary,
    get_diff_line_count,
...
from supervisor.serve.git_ops import compare_branches as git_compare_branches
from supervisor.serve.remote_branches import list_remote_branches
...
async def api_inspect_remote_branch(repo: str, branch: str) -> object:
    ...
    """
    from supervisor.serve.inspect_ops import inspect_remote_branch
...
async def api_close_branch(
    ...
    from supervisor.commands.fin import close_branch
...
async def api_rename_branch(
    ...
    from supervisor.commands.branch import BranchError, rename_branch
...
async def api_branch_switch(
    ...
    from supervisor.serve.server import app
