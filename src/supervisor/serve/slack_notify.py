...
from supervisor.serve.push import DEFAULT_PREFERENCES
from supervisor.serve.roster import all_members, resolve
...
class SlackNotifier:
    ...
    async def _send(self, slack_user_id: str, text: str) -> None:
        ...
        from supervisor.serve.providers.slack import _provider as slack_provider
