...
from supervisor.serve.supabase import read_supabase_version

if TYPE_CHECKING:
    from pathlib import Path

    from supervisor.serve.subprocess_utils import OutputCallback
...
def compose_up_streaming(
    ...
    from supervisor.serve.subprocess_utils import run_streaming
