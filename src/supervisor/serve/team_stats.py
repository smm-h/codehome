...
Usage::
    ...
    from supervisor.serve.team_stats import collect_all_stats, save_stats
...
from supervisor.paths import repo_anchor, repo_branches, resolve_global, superv_home
from supervisor.serve.logging_config import get_logger
from supervisor.serve.roster import TeamMember, all_members
...
def collect_linear_stats(member: TeamMember, linear_token: str | None = None) -> dict[str, int] | None:
    ...
    from supervisor.linear_shared import LinearAPIError, graphql_with_token
