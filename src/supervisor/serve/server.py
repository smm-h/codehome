...
from supervisor.serve.discovery import discover_docker, discover_running
from supervisor.serve.error_tracking import init_sentry
from supervisor.serve.events import events
from supervisor.serve.metrics import metrics_collector
from supervisor.serve.monitoring.health import health_checker
from supervisor.serve.monitoring.logs import log_aggregator
from supervisor.serve.ports import ports
from supervisor.serve.pty_manager import pty_manager
from supervisor.serve.push import push_manager
...
async def lifespan(app: FastAPI) -> AsyncGenerator[None, None]:
    ...
    from supervisor.serve.logging_config import configure_logging
    ...
    from supervisor.bus.subscribers.sse import install_sse_subscriber
    ...
    from supervisor.serve.fetch_scheduler import fetch_scheduler
    ...
    if features.enabled("slack"):
        from supervisor.serve.slack_notify import SlackNotifier
    ...
    if _DEV_MODE:
        from supervisor.serve.vite_dev import drain_vite_output, start_vite_dev
    ...
    if vite_proc is not None:
        from supervisor.serve.vite_dev import stop_vite_dev
    ...
    if features.enabled("conductor"):
        from supervisor.serve.conductor import (
...
from supervisor.serve.rate_limit import SLOWAPI_AVAILABLE, limiter  # noqa: E402
...
from supervisor.serve.csrf import CSRFMiddleware  # noqa: E402

app.add_middleware(CSRFMiddleware)

# -- Request tracing middleware --------------------------------------------
from supervisor.serve.middleware import RequestIDMiddleware, RequestTimingMiddleware  # noqa: E402
...
from supervisor.paths import ROOT as _ROOT  # noqa: E402
from supervisor.plugins.loader import load_all_plugins as _load_plugins  # noqa: E402

_load_plugins(_ROOT)

# -- Import and mount routers ---------------------------------------------

from supervisor import features  # noqa: E402
from supervisor.serve.routers import (  # noqa: E402
    agents,
    auth,
    branches,
    conductor,
...
from supervisor.serve.routers import plugins as plugins_router  # noqa: E402
from supervisor.serve.routers import services as services_router  # noqa: E402
...
if features.enabled("plugins"):
    from supervisor.plugins import registry as _plugin_registry
...
if not _DEV_MODE:
    from supervisor.serve.static_files import router as _static_router
...
_vite_proxy = None
if _DEV_MODE:
    from supervisor.serve.vite_dev import ViteProxyMiddleware
