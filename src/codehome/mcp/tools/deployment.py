...
def stage_branch(
    ...
    """Trigger staging merge for a branch via the server API."""
...
def create_prod_pr(
    ...
    """Create a production PR for a branch via the server API."""
...
def check_pipeline(
    ...
    """Check pipeline status for a branch via the server API."""
