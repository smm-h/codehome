...
from codehome.paths import resolve_global, superv_home, worktree_path
...
def _build_diff_text(repo: str, branch: str) -> str:
    ...
    codehome.summary), which includes commits, file list, and full diff.
    """
    from codehome.git import staleness_tag
    from codehome.summary import branch_summary
