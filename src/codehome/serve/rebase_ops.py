...
from codehome.git import commits_behind, git, git_passthrough
from codehome.migrations import detect_stale_migrations
...
from codehome.serve.subprocess_utils import run_git
...
def rebase_dry_run(repo: str, branch: str) -> dict[str, object]:
    ...
    """
    from codehome.git import is_worktree_locked
...
def rebase_execute(
    ...
    *,
    ...
    from codehome.commands.git_cmd import (
        _conflict_file_list,
