...
from codehome.serve.dependencies import get_error_log, get_event_manager, get_update_checker
from codehome.serve.error_log import ErrorLog
from codehome.serve.events import EventManager
from codehome.serve.preferences import (
    DEFAULT_PREFERENCES,
    delete_preference,
    get_preference,
...
from codehome.serve.system import get_system_status, run_health_checks
from codehome.serve.system_ops import (
    build_health_status,
    find_logo,
...
async def sse_endpoint(events: EventManager = Depends(get_event_manager)) -> StreamingResponse:
    _sse_log = logging.getLogger("codehome.serve.sse")
