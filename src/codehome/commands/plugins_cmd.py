...
def cmd_plugins(args: argparse.Namespace) -> None:
    ...
    """
    from codehome.cli_helpers import dispatch_subcommand
...
def _cmd_list(args: argparse.Namespace) -> None:
    ...
    from codehome.plugins.state import load_state
...
def _set_enabled(args: argparse.Namespace, *, enabled: bool) -> None:
    ...
    from codehome.plugins.state import load_state, save_state
