...
from codehome.cli_helpers import dispatch_subcommand, resolve_from_args, resolve_optional
...
def _fetch_services() -> list[dict[str, Any]]:
    ...
    from codehome.dispatch import server_running
...
def _services_delete_volumes(args: argparse.Namespace) -> None:
    ...
    down -v directly.
    """
    from codehome.serve.docker import COMPOSE_FILE, compose_project_name
...
def _delete_volumes_for_branch(branch_qualified: str, compose_file: Path, compose_project_name_fn: Callable[[str], str]) -> None:
    ...
    from codehome.dispatch import dispatched
