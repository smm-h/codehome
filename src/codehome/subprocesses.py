"""Generic subprocess utilities.

Provides safe wrappers around git and gh CLI calls with consistent
timeout handling, error recovery, and logging.  Also provides a
streaming subprocess runner with line-by-line output callbacks.

These are general-purpose helpers with no domain logic -- they belong
in codehome core so that both core modules and plugins can use them
